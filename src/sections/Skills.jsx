...
const iconMap = {
  '>_':  <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="4 17 10 11 4 5"/><line x1="12" y1="19" x2="20" y2="19"/></svg>,
  ...
  return (
    <section id="skills" className="bg-white">
      <div className="section-container">
        <SectionTitle
          title="Skills"
          subtitle="I've worked with a range of technologies across robotics, embedded engineering, and full-stack web development."
        />
          ...
          {skillCategories.map((cat, i) => (
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 rounded-xl bg-blue-50 text-accent flex items-center justify-center flex-shrink-0">
                  {iconMap[cat.icon] || <span className="text-sm font-mono">{cat.icon}</span>}
                </div>
                <h3 className="font-bold text-slate-800 leading-snug">{cat.title}</h3>
              </div>
